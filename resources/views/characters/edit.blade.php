            ...
            <form action="{{ route('admin.characters.update', $character) }}" method="POST">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <div class="form-check">
                        <input @checked( in_array($weapon->id, old('weapons',$character->items->pluck('id')->all() )) ) name="weapons[]" class="form-check-input" type="checkbox" value="{{ $weapon->id }}" id="weapon-{{$weapon->id}}">
